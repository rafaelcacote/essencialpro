@php
    $formTitle = $formTitle ?? 'Pedido de Orçamento';
    $formSubtitle = $formSubtitle ?? 'Preencha o formulário com os seus dados e os produtos pretendidos. Respondemos habitualmente entre 24h a 48h.';
    $submitLabel = $submitLabel ?? 'Enviar Pedido de Orçamento';
@endphp
                    ...
                    <div class="row g-3">
                        <div class="col-12 text-center">
                            <button class="btn btn-primary py-3 px-5" type="submit" id="submitBtn">
                                <span id="submitText">{{ $submitLabel }}</span>
