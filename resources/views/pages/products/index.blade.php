                ...
                <div class="col-lg-3 mb-4">
                    <div class="product-filters-sidebar">
                        ...
                        <div class="filter-section mb-4">
                            ...
                            <form id="priceFilterForm" method="GET" action="{{ route('product') }}">
                                @if(request('category'))
                    ...
                    <div class="product-controls mb-4">
                        <div class="d-flex flex-wrap justify-content-between align-items-center gap-3">
                            ...
                            <div class="sort-control">
                                <form method="GET" action="{{ route('product') }}" id="sortForm">
                                    @if(request('category'))
                                        <input type="hidden" name="category" value="{{ request('category') }}">
                                    @endif
...
/* Link preenche a área para o <img> ter dimensões definidas — object-fit só funciona assim */
